...
//         if (data.faculty_id) {
//           getFacultyHierarchyData(data.faculty_id);
//         }

//         if (data.central_dept_id) {
//           getCentralDepartmentHierarchyData(data.central_dept_id);
//         }

//         if (data.campus_id) {
//           getCampusHierarchyData(data.campus_id);
//         }

//         if (data.dept_id) {
//           getDepartmentHierarchyData(data.dept_id); //
//         }
//       }}
...
//       case "central_department":
//         getCentralDepartmentHierarchy(id);
//         break;

//       case "campus":
//         getCampusHierarchy(id);
//         break;

//       case "faculty":
//         getFacultyHierarchy(id);
//         break;

//       case "program":
//         getProgramHierarchy(id);
//         break;
