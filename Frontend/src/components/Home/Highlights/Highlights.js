...
const Highlights = () => {
  ...
  return (
    <div className="mb-8 py-10">
      <h1 className="text-2xl font-bold text-center mb-12 text-gray-900 pb-2 relative">
        हाम्रा विशेषताहरू
      ...
      <div className="mt-16 max-w-3xl mx-auto bg-blue-500 p-6 rounded-lg text-center">
        <h3 className="text-xl font-bold mb-3 text-blue-900">
          हाम्रो उद्देश्य
        </h3>
        <p className="text-gray-700">
          त्रिभुवन विश्वविद्यालयको प्रमुख उद्देश्य भनेको उच्च शिक्षाको माध्यमबाट
          नेपाली समाजको आर्थिक, सामाजिक र सांस्कृतिक विकासमा योगदान पुर्‍याउनु
          हो। हामी राष्ट्रिय र अन्तर्राष्ट्रिय क्षेत्रमा प्रतिस्पर्धी हुन सक्ने
          दक्ष र उत्तरदायी नागरिकहरू तयार गर्न प्रतिबद्ध छौं।
        </p>
      </div>
    </div>
  );
