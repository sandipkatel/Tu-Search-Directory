...
INSERT INTO CAMPUS (ho_id, name, location, website) VALUES
...
INSERT INTO CENTRAL_DEPARTMENT (org_id, name, contact, location, website, isActive) VALUES
...
(1, "Central Department of Library and Information Science", "info@cdlis.tu.edu.np", "Kirtipur, Kathmandu", "https://cdjmc.tu.edu.np/", TRUE),
(1, "Office of the Controller of Examination", "Info@exam.tu.edu.np", "Kirtipur, Kathmandu", "https://cdlis.tu.edu.np/", TRUE);

INSERT INTO DEPARTMENT (c_id, name, contact) VALUES
...
-- Central Office
INSERT INTO PERSONNEL (name, email, position, imageUrl, org_id) VALUES
...
-- Institute/Faculty
INSERT INTO PERSONNEL (name, email, position, imageUrl, faculty_id) VALUES
...
-- Campus
INSERT INTO PERSONNEL (name, email, position, imageUrl, campus_id) VALUES
...
-- Central departments
INSERT INTO PERSONNEL (name, email, position, imageUrl, c_dept_id) VALUES
("Prof. Dr. Subarna Shakya", "drss@ioe.edu.np", "Head, Central Department of Computer Science and IT", "https://cdcsit.edu.np/wp-content/uploads/avatars/13/5f1d1b969cf99-bpfull.jpg", 201);

INSERT INTO PERSONNEL (name, email, position, imageUrl, dept_id) VALUES
...
("Asst. Prof. Dr. Aman Shakya", "aman.shakya@ioe.edu.np", "Assitant Professor", "https://lh5.googleusercontent.com/jev9NNgjJj22400sRwtiaNGc5qFEVt5JVE3T8AeM5AxK6Nk-BTKFsKZJNVuaFkd4UmGlvNtqgIlClic9Cb5XrBn5UdFR7z6U67QbZHazkz_x3zJpTCxpES3heOH0Yhp9cw=w1280", 101);

INSERT INTO PROGRAM (name, about, director_id) VALUES
